...
public class Instructions {
	protected void printInstructions(Start window) {
		String printInstructions = "<html>Welcome to the Decision Making Adventure, "
				+ "made by Skylar Phanenhour!<br/><br/>"

				+ "When you start the game, you will be given some statistics<br/>" + "for your character: <br/>"
